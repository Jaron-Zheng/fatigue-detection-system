 ...
 *
 * 图表的创建参数、主题取色、尺寸重测、参考线随标定结果更新等绘图细节集中在此。
 */
...
export class WorkbenchCharts {
  ...
  constructor({ onResize }) {
    ...
    // 疲劳指数图：双线（原始分 + EMA 平滑分），含等级色带与参考线
    ...
    // EAR/MAR 双线图：闭眼阈值与张口阈值参考线随标定结果动态更新
  ...
  refreshColors() {
    ...
    this.eye.opts.series[0].color = cssVar('--chart-ear', '#3e6ae1');
   ...
   * @param {{score:Array, raw:Array, ear:Array, mar:Array}} waves
   * @param {object|null} calib 校准结果
