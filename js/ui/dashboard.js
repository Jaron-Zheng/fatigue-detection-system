...
const GAUGE_CIRC = 2 * Math.PI * 50; // 环形仪表圆周长（r=50）
const LEVEL_COLOR = {
  awake: 'var(--lv-awake)',
  mild: 'var(--lv-mild)',
...
export class Dashboard {
  ...
  /* 缓存所有需要操作的 DOM 元素引用，避免每帧 getElementById */
  _bind() {
    const ids = [
  ...
  /* 指标卡刷新（约 6Hz，人眼看不出差别，却能省下大量 DOM 写入） */
   ...
   * @param {string} state 卡片状态（normal/caution/danger）
   */
