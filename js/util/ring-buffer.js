...
export class TimeWindow {
  ...
  /* 动态调整窗口大小：扩容时迁移数据，缩小时立即驱逐超出新范围的旧样本 */
 ...
 *
 * PERCLOS 的定义是"时间占比"，不是"帧占比"。
 * 早期实现用"命中帧数 ÷ 总帧数"近似，隐含假设每帧间隔相同。
 * 实际运行中帧间隔会波动，按帧计数会把闭眼的真实时间占比低估。
 *
