...
const HOME_DESKTOP = path.join(os.homedir(), 'Desktop');
...
/* ---------- 4. 说明书截图（复制到 img/，自包含） ---------- */
const figSrc = [
  ['fig01.png', path.join(HOME_DESKTOP, 'ppt/shots/01-hero.png')],
  ['fig02.png', path.join(HOME_DESKTOP, 'ppt/shots/02-signals.png')],
  ['fig03.png', path.join(HOME_DESKTOP, 'ppt/shots/03-dataflow.png')],
  ['fig04.png', path.join(HOME_DESKTOP, 'ppt/shots/04-numbers.png')],
  ['fig05.png', path.join(HOME_DESKTOP, 'ppt/shots/05-workbench.png')],
  ['fig06.png', path.join(HOME_DESKTOP, 'ppt/shots/06-alarm.png')],
  ['fig07.png', path.join(HOME_DESKTOP, 'ppt/shots/09-severe2.png')],
  ['fig08.png', path.join(HOME_DESKTOP, '参赛作品/竞赛材料/_work/check/03_设置抽屉.png')],
  ['fig09.png', path.join(HOME_DESKTOP, 'ppt/shots/07-report.png')],
  ['fig10.png', path.join(HOME_DESKTOP, '参赛作品/竞赛材料/_work/check/07_浅色参照.png')],
  ['fig11.png', path.join(HOME_DESKTOP, '参赛作品/竞赛材料/_work/check/08_深色主题.png')],
];
