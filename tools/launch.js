...
function hasSupportedNodeVersion() {
  ...
  if (Number.isInteger(major) && major >= MIN_NODE_MAJOR) return true;
  console.log(`  [X] Node.js ${MIN_NODE_MAJOR} 或更高版本是必需的，当前为 ${process.version}。`);
  console.log('      请安装 Node.js LTS 后重新运行此启动器。');
  return false;
}
