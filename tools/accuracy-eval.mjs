...
const { CONFIG, PERCLOS_MU_LO, PERCLOS_MU_HI } = await importFromWeb('config.js');
...
// 4.1 PERCLOS 隶属下限（默认界统一来自 config.js 的 PERCLOS_MU_LO/HI，此处运行时包一层可参数化换算）
const ORIG_MEMBERSHIPS = FusionEngine.memberships.bind(FusionEngine);
const PERCLOS_LO_DEFAULT = PERCLOS_MU_LO;
const PERCLOS_HI = PERCLOS_MU_HI;
sweepParam(
  'PERCLOS 隶属下限',
